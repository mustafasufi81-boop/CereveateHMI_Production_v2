...
- Network: http://192.168.0.120:5002
...
│ - Access: http://192.168.0.120:5002│
└─────────────────────────────────────┘
```
...
http://192.168.0.120:5002
```

## Helper Scripts

- `ADD_FIREWALL_RULE.bat` - Add Windows Firewall rule for port 5002
