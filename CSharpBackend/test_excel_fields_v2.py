...
if login_response.status_code == 200:
    ...
    if "token" in login_data:
        ...
        url = "http://localhost:6001/api/reports/daily?date=2026-05-18&plant=FTP-1&area=ESP"
        headers = {
            "Content-Type": "application/json",
            "Authorization": f"Bearer {token}"
        }
        
        print("\nTesting daily report API for Excel fields...")
        ...
        print(f"❌ Login response missing access_token: {login_data}")
else:
